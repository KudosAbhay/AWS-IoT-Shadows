...
print "Enter 1 to Turn On the Bulb"
print "Enter 2 to Turn OFF the Bulb"
print "Enter 3 to exit"
data = raw_input("Select an option:")
if data == "1":
	HTTPS_REQUEST_PAYLOAD = """{"state" : {"desired" : {"Turn Bulb" : "ON"}}}"""
elif data == "2":
	HTTPS_REQUEST_PAYLOAD = """{"state" : {"desired" : {"Turn Bulb" : "OFF"}}}"""
elif data == "3":
	sys.exit()
else:
